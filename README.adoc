...
link:https://fetch.usebruno.com?url=https%3A%2F%2Fgithub.com%2Ftelekom%2Fadvanced-coding-assistant-backend[image:https://fetch.usebruno.com/button.svg[Fetch in Bruno]]
