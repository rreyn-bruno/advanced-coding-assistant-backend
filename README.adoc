...
You can also import the collection directly by clicking the `Fetch in Bruno` button below:

[<img src="https://fetch.usebruno.com/button.svg" alt="Fetch in Bruno" style="width: 130px; height: 30px;" width="128" height="32">](https://fetch.usebruno.com?url=https%3A%2F%2Fgithub.com%2Ftelekom%2Fadvanced-coding-assistant-backend "target=_blank rel=noopener noreferrer")
